...
public class LoyaltyCardEditActivity extends CatimaAppCompatActivity {
    ...
    private ActivityResultLauncher<Intent> imageFromFileFrontResultLauncher;
    private ActivityResultLauncher<Intent> imageFromFileBackResultLauncher;
    private ActivityResultLauncher<Intent> imageFromCameraFrontResultLauncher;
    private ActivityResultLauncher<Intent> imageFromCameraBackResultLauncher;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scanBarcodeResultLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
            @Override
            public void onActivityResult(ActivityResult result) {
                if (result.getResultCode() == RESULT_OK) {
                    BarcodeValues barcodeValues = Utils.parseSetBarcodeActivityResult(Utils.BARCODE_SCAN, RESULT_OK, result.getData(), LoyaltyCardEditActivity.this);
        ...
        imageFromFileBackResultLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
            @Override
            public void onActivityResult(ActivityResult result) {
                if (result.getResultCode() == RESULT_OK) {
                    Bitmap bitmap = null;
                    try {
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                            ImageDecoder.Source image_source = ImageDecoder.createSource(getContentResolver(), result.getData().getData());
        ...
        imageFromFileFrontResultLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
            @Override
            public void onActivityResult(ActivityResult result) {
                if (result.getResultCode() == RESULT_OK) {
                    Bitmap bitmap = null;
        ...
        imageFromCameraBackResultLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
            @Override
            public void onActivityResult(ActivityResult result) {
                if (result.getResultCode() == RESULT_OK) {
        ...
        imageFromCameraFrontResultLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
            @Override
            public void onActivityResult(ActivityResult result) {
                if (result.getResultCode() == RESULT_OK) {
                    Bitmap bitmap = BitmapFactory.decodeFile(tempCameraPicturePath);
    ...
    private void takePhotoForCard(int type) throws IOException {
        ...
        if (type == Utils.CARD_IMAGE_FROM_CAMERA_BACK) {
            imageFromCameraBackResultLauncher.launch(i);
        }else if (type == Utils.CARD_IMAGE_FROM_CAMERA_FRONT) {
            imageFromCameraFrontResultLauncher.launch(i);
        }else if (type == Utils.CARD_IMAGE_FROM_FILE_BACK) {
            imageFromFileBackResultLauncher.launch(i);
        }else if (type == Utils.CARD_IMAGE_FROM_FILE_FRONT) {
            imageFromFileFrontResultLauncher.launch(i);
        }
    }
    ...
    class EditCardIdAndBarcode implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            i.putExtras(b);
            scanBarcodeResultLauncher.launch(i);
        }
    }
