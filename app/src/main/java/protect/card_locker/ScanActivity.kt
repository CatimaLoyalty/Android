...
class ScanActivity : CatimaAppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        customBarcodeScannerBinding.fabOtherOptions.setOnClickListener {
            ...
            builder.setOnCancelListener { _ -> setScannerActive(true) }
            builder.show()
        }
        ...
        val barcodeScannerIntent = Intent().apply {
            putExtra(DecodeHintType.ALSO_INVERTED.name, java.lang.Boolean.TRUE)
        }
    ...
    private fun handleActivityResult(requestCode: Int, resultCode: Int, intent: Intent?)  {
        ...
        val parseResultList: List<ParseResult> = Utils.parseSetBarcodeActivityResult(requestCode, resultCode, intent, this)
    ...
    private fun addWithoutBarcode() {
        ...
        currentTextview.text = getString(R.string.enter_card_id)
    ...
    fun addManually() {
        ...
        builder.setPositiveButton(R.string.continue_) { _, _ ->
        ...
        builder.setNegativeButton(R.string.cancel) { _, _ -> setScannerActive(true)}
        builder.setOnCancelListener { _ -> setScannerActive(true) }
        builder.show()
    }
    ...
    private fun addFromImageOrFileAfterPermission(mimeType: String, launcher: ActivityResultLauncher<Intent>, chooserText: Int, errorMessage: Int) {
    ...
    @Suppress("DEPRECATION") // FIXME: defaultDisplay: Display! is deprecated
    private fun scaleScreen() {
        val displayMetrics = DisplayMetrics()
        windowManager.defaultDisplay.getMetrics(displayMetrics)
        val screenHeight: Int = displayMetrics.heightPixels
        val mediumSizePx: Float = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,MEDIUM_SCALE_FACTOR_DIP.toFloat(),resources.displayMetrics)
    ...
    private fun navigateToSystemPermissionSetting() {
        val permissionIntent = Intent(Settings.ACTION_APPLICATION_DETAILS_SETTINGS, Uri.fromParts("package", getPackageName(), null))
    ...
    override fun onMockedRequestPermissionsResult(requestCode: Int, permissions: Array<String?>, grantResults: IntArray) {
        ...
        } else if (requestCode in listOf(PERMISSION_SCAN_ADD_FROM_IMAGE, PERMISSION_SCAN_ADD_FROM_PDF, PERMISSION_SCAN_ADD_FROM_PKPASS)) {
            if (granted) {
